...
description:
  Identity, metadata, hashes, and what actually makes two files "the same,"
  and why the filesystem, the operating system, and the user each answer
...
revisions:
  ...
  - version: "1.0"
    note:
      ...
      do, and ran into the next week's question with no section break. It
      was the only lecture that ended without one.
related:
