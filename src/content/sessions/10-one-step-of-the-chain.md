---
title: One Step of the Chain
description:
  Run a single format conversion on a document you know well and inventory
  exactly what did not survive it
week: 10
date: 2027-04-26
teachers:
  - idris-fenn
...
spec:
  ...
  - one thing lost that the target format could have carried but the converter dropped anyway
---
...
Identify one loss the target format did not require. Comments, for instance,
survive in some DOCX-to-PDF converters and not others; the format can hold
an annotation, and the converter chose not to write one. Separating what the
format cannot carry from what the tool declined to carry is the whole
distinction, and it is the one the Format Autopsy is graded on.
