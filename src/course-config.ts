...
export const courseMeta = slopCourseMetaSchema.parse({
  ...
  endDate: "2027-05-28",
  description:
    "Twelve weeks of file forensics. Every week ends with a duplicate, a " +
    "conflict, or a decision about which copy counts, and you write down " +
    "why you decided that.",
  tags: ["file forensics", "version control", "digital archives"],
