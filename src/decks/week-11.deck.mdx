...
- an embedded application version — an edit placed within a range of years
- flattened styles — passed through a fixed-layout format
- a departed colleague's name in a filename — who held it, once
